...
const courseData: Record<string, {
  ...
  "guida-difensiva-emergenza": {
    ...
    description: "Il percorso formativo è progettato per fornire ai conducenti professionali le competenze necessarie per prevenire situazioni di pericolo e gestire con razionalità le criticità dinamiche del veicolo. L'approccio si focalizza sulla riduzione del rischio residuo attraverso l'adozione di protocolli di guida difensiva e il controllo del mezzo in contesti operativi complessi o in situazioni di emergenza imprevista.",
    obiettivi: [
      "Acquisire tecniche avanzate di osservazione e percezione del rischio ambientale.",
      "Comprendere e gestire i trasferimenti di carico durante le manovre d'emergenza.",
      "Standardizzare le procedure di frenata d'emergenza con l'ausilio di sistemi elettronici (ABS/ESP).",
      "Sviluppare la capacità di controllo del veicolo in caso di perdita di aderenza accidentale.",
      "Ottimizzare la coordinazione psicomotoria per ridurre i tempi di reazione efficaci.",
    ],
    destinatari: [
      "Personale dipendente che utilizza veicoli aziendali per lunghe percorrenze.",
      "Autisti di rappresentanza e addetti ai servizi di scorta o sicurezza.",
      "Operatori della sicurezza privata e vigilanza.",
      "Professionisti che operano in contesti ad alto rischio stradale.",
    ],
    durata: {
    ...
    programmaTeoria: [
      ...
      "Dinamica delle forze: accelerazione longitudinale e trasversale (G-force).",
      "Sistemi di sicurezza attiva: funzionamento e limiti della tecnologia di bordo.",
      "Psicologia della guida: stress, visione a tunnel e gestione del panico.",
      "Strategie di guida difensiva: mantenimento degli spazi di manovra e posizionamento stradale.",
    ],
    programmaPratica: [
      "Posizione di guida corretta: ergonomia per il controllo rapido e reattivo dei comandi.",
      "Slalom dinamico e tecniche di sterzata: gestione corretta del passaggio delle mani.",
      "Frenata d'emergenza con evitamento ostacolo su fondo a bassa aderenza.",
      "Controllo della sbandata: gestione del sottosterzo e del sovrasterzo su superfici bagnate o ghiacciate.",
      "Frenata differenziata (µ-split): gestione del veicolo con ruote su superfici ad aderenza asimmetrica.",
      "Manovra di scarto improvviso: tecniche di scarto laterale per ostacoli fissi o mobili senza perdita di controllo.",
    ],
